            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-xs">
                <p className="text-muted-foreground">
                  Transio is open source software released under the MIT License. 
                  You're free to use, modify, and redistribute it for any purpose.
                </p>
                ...
                <div className="bg-muted p-3 rounded-lg border border-border space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    ...
                    <Badge variant="outline" className="text-[10px]">Vite 7</Badge>
                    <Badge variant="outline" className="text-[10px]">Tailwind CSS 4</Badge>
                    <Badge variant="outline" className="text-[10px]">shadcn/ui v4</Badge>
                    <Badge variant="outline" className="text-[10px]">CodeMirror 6</Badge>
                    <Badge variant="outline" className="text-[10px]">Saxon-JS 2.7</Badge>
                  </div>
                </div>
              </div>
            </div>
