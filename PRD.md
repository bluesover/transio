...
**Desktop Applications**: On-premise desktop apps for Windows, macOS, and Linux with one-click installation, auto-install of Saxon-HE and Java runtime, and full offline operation. Available for download from GitHub Releases.
